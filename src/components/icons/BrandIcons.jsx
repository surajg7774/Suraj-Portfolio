// lucide-react (current major) dropped trademarked brand icons entirely, so
// GitHub/LinkedIn are hand-rolled here as plain SVGs (Simple Icons path
// data, CC0) with a lucide-compatible `size`/className API.
